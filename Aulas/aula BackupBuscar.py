...
class Application(Funcs, Relatorios):
    ...
    def widgets_frame1(self):
        # Botões Limpar
        self.bt_limpar = Button(self.frame_1,text="Limpar", bd=3, bg="#107db2", fg="#FFF", font=('verdana', 8, 'bold'), command=self.limpa_cliente)
        self.bt_limpar.place(relx=0.2, rely=0.1, relwidth=0.1, relheight=0.15)   
             
        # Botões Buscar
        self.bt_buscar = Button(self.frame_1,text="Buscar", bd=3, bg="#107db2", fg="#FFF", font=('verdana', 8, 'bold'), command=self.busca_cliente)
        self.bt_buscar.place(relx=0.3, rely=0.1, relwidth=0.1, relheight=0.15)
        
        # Botões Novo
        self.bt_novo = Button(self.frame_1,text="Novo", bd=3, bg="#107db2", fg="#FFF", font=('verdana', 8, 'bold'), command=self.add_cliente)
        self.bt_novo.place(relx=0.6, rely=0.1, relwidth=0.1, relheight=0.15)
        
        # Botões Alterar
        self.bt_alterar = Button(self.frame_1,text="Alterar", bd=3, bg="#107db2", fg="#FFF", font=('verdana', 8, 'bold'), command=self.altera_cliente)
        self.bt_alterar.place(relx=0.7, rely=0.1, relwidth=0.1, relheight=0.15)
        
        # Botões Apagar
        self.bt_apagar = Button(self.frame_1,text="Apagar", bd=3, bg="#107db2", fg="#FFF", font=('verdana', 8, 'bold'), command=self.deleta_cliente)
